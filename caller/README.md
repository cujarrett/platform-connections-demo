...
POC — deployed as a plain manifest in the `poc-caller` namespace (twice: `authorized-caller` and `unauthorized-caller`), not yet as `XApi` instances. Image: `ghcr.io/cujarrett/caller`. ARM64.
